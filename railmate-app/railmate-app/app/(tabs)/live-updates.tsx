...
type FilterType = null | { type: 'DELAY' } | { type: 'CROWD' };
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <View style={styles.filters}>
        ...
        <Chip
          label="Crowding"
          isActive={filter?.type === 'CROWD'}
          onPress={() => setFilter({ type: 'CROWD' })}
        />
      </View>
            ...
            <LiveUpdateCard
              ...
              update={{
                ...
                status_type: update.report_type === 'DELAY' ? 'delay' :
                             ...
                             update.report_type === 'SCHEDULE' ? 'on_time' :
                             update.report_type === 'PLATFORM' ? 'platform' : 'halted',
                ...
                reporter_count: update.verification_count,
              }}
              onPress={() => {
                if (update.train_id) {
