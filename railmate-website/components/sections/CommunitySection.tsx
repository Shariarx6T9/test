          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center relative z-10">
            <div className="space-y-8">
              ...
              <div className="flex flex-col gap-4">
                 <div className="flex gap-4">
                    <div className="w-12 h-12 rounded-radius-md bg-bg-card border border-border flex items-center justify-center flex-shrink-0">
            ...
            <div className="space-y-4">
              {reports.map((report) => (
                <div 
                  key={report.id}
                  className="p-6 bg-bg-card border border-border rounded-radius-lg hover:border-border-strong transition-colors group"
                >
              ...
              <div className="p-4 bg-bg-card/50 border border-border/50 rounded-radius-lg blur-[1px] scale-95 origin-top opacity-50" />
            </div>
          </div>
        </div>
      </div>
